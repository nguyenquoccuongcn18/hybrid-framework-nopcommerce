...
public class PIM_01_Employee_List_Live extends BaseTest {
    ...
    public void beforeClass(String browserName,String url) {
        ...
        sleepInsecons(3);
        loginPage.inputToUsernameField(GlobalConstants.getGlobalConstants().getAdminOrgangeHrmUsernameLive());
        sleepInsecons(3);
        loginPage.inputToPasswordField(GlobalConstants.getGlobalConstants().getAdminOrgangeHrmPasswordLive());
        sleepInsecons(3);
