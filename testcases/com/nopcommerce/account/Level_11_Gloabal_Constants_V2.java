...
public class Level_11_Gloabal_Constants_V2 extends BaseTest {
    ...
    private AdminDashboardPageObjects adminDashboardPage;
     ...
     private String adminUrl = GlobalConstants.getGlobalConstants().getDevAdminUrl();
    private String endUserUrl = GlobalConstants.getGlobalConstants().getDevUserUrl();
    ...
    public void User_01_User_To_Admin() {
        ...
        adminDashboardPage = adminLoginPage.clickToLoginButtonAdmin(GlobalConstants.getGlobalConstants().getDevAdminUsername(),GlobalConstants.getGlobalConstants().getDevAdminPassword());
