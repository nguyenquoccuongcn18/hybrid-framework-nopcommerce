...
public class ExtentManager {
    ...
    public synchronized static ExtentReports createExtentReports() {
        ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.getGlobalConstants().getRelativeProjectPath() + "/extentV5/ExtentReport.html");
        ...
        extentReports.setSystemInfo("Team", "Cuong TestAutomation");
