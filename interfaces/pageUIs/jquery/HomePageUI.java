...
public class HomePageUI {
    ...
    public static final String PAGE_LINK_BY_NUMBER_ACTIVE = "xpath=//a[@class='qgrd-pagination-page-link active' and text()=%s]";
    ...
    public static final String CLICK_CLOSE_POPUP = "xpath=//input[@type='submit']";
    ...
    public static final String DYNAMIC_COLUMN_INDEX_BY_COLUMN_NAME_01 = "xpath=//th[text()='Contact Person']";
